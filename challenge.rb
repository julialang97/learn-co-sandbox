...
# our_class[:Ilana]=[:favorite_foods

#add yourself and one more classmate into our_class. Make sure to fill in all necessary information.
# our_class[:Julia]={:hometown => "orinda", :birthday => "April 26", :favorite_foods => ["candy","Fries","popcorn"]}
# our_class[:Lizzy]={:hometown => "berkely", :birthday => "June 21", :favorite_foods => ["doughnuts","Fries","popcorn"]}
# puts our_class
